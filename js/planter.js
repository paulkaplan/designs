...
Planter = function(canvas) {
  ...
  draw = ko.computed(function() {
    var base, baseTab, baseTabOffset, baseTabs, halfSideHeight, halfSideWidth, halfWidth, insetPanel, outsetPanel, sideBaseTabOffset, sideTabOffset, svg, _i, _len;
    ...
    for (_i = 0, _len = baseTabs.length; _i < _len; _i++) {
      baseTab = baseTabs[_i];
